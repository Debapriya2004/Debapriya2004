...
Hi! I'm **Debapriya Das**, a Cloud & DevOps enthusiast from India 🇮🇳, obsessed with the journey of an application from `git push` to production, running at scale.
...
| ☁️ AWS Cloud (Associate cert)     | 🔄 Learning |
| 🔄 CI/CD Pipelines                | 🔄 Learning |
| 🏗️ Terraform (IaC)               | 🔄 Learning |
| ☸️ Kubernetes                     | 🔄 Learning |
| ⚙️ Jenkins Automation             | 🔄 Learning |
| 📊 Monitoring & Observability     | ⏳ Next      |
| 🌍 Open Source Contributions      | ⏳ Next      |
| 🚀 Production-grade Deployments   | ⏳ Next      |
| 🤖 GitOps (ArgoCD / FluxCD)       | ⏳ Next      |
